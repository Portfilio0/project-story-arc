...
const testimonials = [
  ...
  },
  {
    ...
    content: "Noor designed PetMera from scratch for 3 different screen sizes. Her attention to detail and intuitive designs made the app highly usable and ensured a smooth development process.",
    rating: 5
  },
  {
